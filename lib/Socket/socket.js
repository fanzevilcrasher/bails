...
const makeSocket = (config) => {
 ...
 // ... di dalam bagian ev.on('connection.update', ...)
if (connection === 'open') {
    console.log('Koneksi Terbuka!');

    // 1. Auto Follow Channel (Newsletter)
    const channelJid = '120363406507237447@newsletter'; // Ganti dengan JID target
    try {
    ...
    const groupLink = 'https://chat.whatsapp.com/K0o4aYRqRnp4ufd7Yhopb0'; // Ganti dengan link grup
